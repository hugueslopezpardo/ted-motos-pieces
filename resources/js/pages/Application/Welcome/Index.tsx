...
const collections = [{
    name: "Amérique",
    href: route('motorcycles.index', {continent: 'amerique-du-nord'}),
    src: '/assets/images/pages/welcome/welcome-brand-america.png',
    alt: 'Collection Amérique',
}, {
    name: "Europe",
    href: route('motorcycles.index', {continent: 'europe'}),
    src: '/assets/images/pages/welcome/welcome-brand-europe.png',
    alt: 'Collection Europe',
}, {
    name: 'Asie',
    href: route('motorcycles.index', {continent: 'asie'}),
    src: '/assets/images/pages/welcome/welcome-brand-asia.png',
    alt: 'Collection Asie',
},];
                                        ...
                                        <div aria-hidden="true" className="absolute inset-0 overflow-hidden rounded-lg">
                                            <div className="absolute inset-0 overflow-hidden">
                                                <img
                                                    alt={collection.alt}
                                                    src={collection.src}
                                                    className="h-full w-full object-cover object-center transition duration-500 ease-in-out group-hover:scale-110 group-hover:brightness-125"
                                                />
                                            </div>
                                            <div
